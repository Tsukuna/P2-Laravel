...
@section('content')
    ...
    <section class="bg-[var(--primary-color)]">
        ...
        <div class="text-center text-[var(--secondary-color)] leading-[1.2] tracking-wider mt-5"
        ...
        <form action="{{route('contact.store')}}" method="POST" class="space-y-8 bg-transparent font-sans">
            ...
            <div class="dropdown-container w-full">
                ...
                <option disabled selected> Srevices </option>
                <option value="passport">Passport</option>
                <option value="hotel_booking">Hotel Booking</option>
                <option value="flight_booking">Flight Booking</option>
                <option value="visa_processing_service">Visa Processing Service</option>
                <option value="hostpital_service">Hospital Connection Service</option>
